...
public class Obstacles {
    ...
    Texture txt;
    int betweenDistance;
    public static float[][] arr = new float[50][2];
    ...
    public void render(SpriteBatch batch) {
        for(int i=0; i<obs.length; i++) {
            ...
            arr[i][0] = obs[i].position.y - obs[i].offset+txt.getHeight();
            arr[i][1] = obs[i].position.y + betweenDistance + txt.getHeight() - obs[i].offset;
        }
    }
